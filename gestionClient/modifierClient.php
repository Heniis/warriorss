    ...
    if (isset($_GET['idC'])) {
        if (!empty($_POST)) {
          ...
          //  $id = isset($_POST['id']) ? $_POST['id'] : NULL;
            ...
            // Update the record
            $stmt = $pdo->prepare('UPDATE client SET  nomUser = ?, prenomUser = ?, addresse = ?, id_produit = ?, quantite = ?, modeLivraison = ?, modePaiement = ?, mail = ?, status = ? WHERE idC = ?');
     ...
     $stmt = $pdo->prepare('SELECT * FROM client WHERE idC = ?');
       $stmt->execute([$_GET['idC']]);
      $client = $stmt->fetch(PDO::FETCH_ASSOC);
        if (!$client) {
           exit('client doesn\'t exist with that idC!');
        }
    } 
    else {
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#tables" aria-expanded="false" aria-controls="tables">
              ...
              <span class="menu-title">Gesttion client</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
  
                <li class="nav-item"> <a class="nav-link" href="../../pages/gestionclient/consulterclient.php">Consulter client</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/gestionclient/Statclient.php">stat client</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="body">
                            <form action="modifierclient.php?idC=<?=$client['idC']?>" method="POST">
					...
					<div class="form-group">	
                            ...
                            <tr>
            <td>nomUser</td>
            <td><input type='text' name='nomUser' value ="<?php echo $client['nomUser'];?>" class='form-control' /></td>
        </tr>
        <tr>
            <td>prenomUser</td>
            <td><input type='text' name='prenomUser'  value ="<?php echo $client['prenomUser'];?>" class='form-control' /></td>
        </tr>
        
        <tr>
            <td>addresse</td>
            <td><input type='text' name='addresse'  value ="<?php echo $client['addresse'];?>" class='form-control' /></td>
        </tr>
        
        <tr>
            <td>id_produit</td>
            <td><input type='text' name='id_produit'value ="<?php echo $client['id_produit'];?>" class='form-control' /></td>
        </tr>
        <tr>
            <td>quantite</td>
            <td><input type='text' name='quantite'value ="<?php echo $client['quantite'];?>" class='form-control' /></td>
        </tr>
        <tr>
            <td>modeLivraison</td>
            <td><input type='text' name='modeLivraison'value ="<?php echo $client['modeLivraison'];?>" class='form-control' /></td>
        </tr>
        <tr>
            <td>modePaiement</td>
            <td><input type='text' name='modePaiement'value ="<?php echo $client['modePaiement'];?>" class='form-control' /></td>
        </tr>
        <tr>
            <td>mail</td>
            <td><input type='text' name='mail'value ="<?php echo $client['mail'];?>" class='form-control' /></td>
        </tr>
        <tr>
            <td>status</td>
            <td><input type='text' name='status'value ="<?php echo $client['status'];?>" class='form-control' /></td>
        </tr>
        <tr>
        ...
        <div class="form-group">
					...
					<div class="form-group">								
						...
						<p><br>Wants new Captcha code? <a href="javascript:void(0)" id="refreshCaptchaCode">refresh</a></p>
                                        ...
                                        <a href='consulterclient.php' class='btn btn-danger'>Back</a>
                                </table>
                            </form>
                            <?php if ($msg): ?>
    <p><?=$msg?></p>
